    ...
    <div className="flex flex-col min-h-screen h-auto relative">
      <Head>
        ...
        <meta
          ...
          content="DDOX"
        />
        <meta name="author" content="Roopesh Vetcha" />
        <meta property="og:site_name" content="DDOX.dev" />
        <meta property="og:site" content="http://www.ddox.dev" />
        <meta property="og:title" content="DDOX.dev" />
        <meta
          property="og:description"
          content="Supercharge Your GitHub Profile"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Supercharge Your GitHub Profile"
        />
        <meta property="twitter:creator" content="@roopeshvetcha" />
      </Head>
      ...
      <header className="flex items-center fixed top-0 w-full h-16 z-40 bg-light-100 dark:bg-dark-800 border-b-0 border-slate-200 dark:border-dark-700 ">
        ...
        >
          ...
          >
           <img src="./favicon.png" alt="DDOX Logo" className="w-10 h-10"/>
          </motion.button>
              ...
              >
                <ul className="flex flex-col">
                  <li className="border-b h-10 border-light-100 dark:border-dark-600 flex items-center group">
                    <a
                      href="mailto:vetcharoopesh@gmail.com"
                  ...
                  <li className="border-b border-light-100 dark:border-dark-600 h-10 flex group">
                    <Link
                      ...
                      href="https://github.com/qwertyroop/DDOX-dev/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                  ...
                  <li className="border-b-0 h-10 flex group">
                    <a
                      ...
                      href="http://www.x.com/RoopeshVetcha"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-end gap-x-3 gap-y-3">
          <div className="mr-auto flex flex-col grow w-full">
            ...
            <div className="mb-0 text-sm w-full">
              <p>
                ...
                <Link href={"/"}>DDOX</Link>. All rights reserved.
              </p>
            </div>
          </div>
          <div className="flex flex-col md:items-end w-full items-start">
            ...
            <div className="flex gap-x-1.5 items-center">
              ...
              <span className="text-dark-400 dark:text-white">·</span>
              <a href="mailto:vetcharoopesh@gmail.com" className="text-xs">
                Leave Feedback
              </a>
            </div>
          </div>
