  ...
  return (
    <>
      <section className="section-header-wrapper">
        <SectionHeader
          header={"Introduction"}
          subhead={`Share a bit about yourself and your background.`}
        />
      ...
      <section className="flex flex-col overflow-y-auto">
        ...
        <section className="flex flex-col p-6 gap-y-5">
          ...
          <IntroItem
            ...
            inputPlaceholder={"Fullstack Developer"}
          />
          {/* Long Description */}
          <IntroTextarea
          ...
          <article className="flex flex-col gap-y-2">
            <IntroItem
              ...
              formLabelText={"Check out my portfolio:"}
              formLabelIcon={"🖥️"}
              section={"introduction"}
              type={"portfolioTitle"}
            ...
            <IntroLinkItem
              ...
              linkPrefix={"https://"}
              type={"portfolioLink"}
              inputPlaceholder={"this_is_my_app.com"}
            />
          </article>
          {/* Email  */}
          <IntroItem
            ref={emailMeRef}
            formLabelText={"Reach me at:"}
            formLabelIcon={"✉️"}
            section={"introduction"}
            type={"emailMe"}
