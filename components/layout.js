  ...
  return (
    <div className="flex flex-col min-h-screen h-auto md:h-screen relative ">
      <Head>
        ...
        <meta property="og:site_name" content="DDOX" />
        <meta property="og:site" content="http://www.DDOX" />
        <meta property="og:title" content="DDOX" />
        <meta
        ...
        <meta
          ...
          content="Supercharge Your GitHub Profile"
        />
        <meta property="twitter:creator" content="@vetcharoopesh" />
      </Head>
