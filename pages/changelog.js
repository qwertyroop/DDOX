  ...
  return (
    ...
    >
      <div className="container mx-auto py-6 md:py-24">
        ...
        <p>All of the changes made to DDOX.dev since launch.</p>
        ...
        <div className="flex w-full bg-white dark:bg-dark-900/40 py-2.5 px-3 rounded-md items-center transition-all duration-150 ease-in-out">
          <p className="mb-0">
            ...
            DDOX.dev, please visit the GitHub repo and make a pull request.
          </p>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/qwertyroop/DDOX-dev/commits/main"
          ...
          <article className="flex gap-x-6 flex-col md:flex-row gap-y-3 border-b border-light-200 dark:border-dark-600 transition-all duration-150 ease-in-out pb-8 md:pb-0">
            ...
            <div className="w-full md:w-1/4 flex flex-col border-r-0 md:border-r border-light-200 dark:border-dark-600 py-0 md:py-6 transition-all duration-150 ease-in-out">
              ...
              <p className="text-sm mb-0">
                Posted by{" "}
                <a href="mailto:vetcharoopesh@gmail.com">Roopesh Vetcha</a>
              </p>
            </div>
              ...
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    ...
                    <a
                      href="https://github.com/qwertyroop/DDOX-dev/commits?author=paytonjewell"
                      target="_blank"
                      rel="noreferrer"
                    >
                      paytonjewel
              ...
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    ...
                    <a
                      href="https://github.com/qwertyroop/DDOX-dev/commits?author=Dharmik48"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Dharmik48
              ...
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    ...
                    by{" "}
                    <a
                      href="https://github.com/qwertyroop/DDOX-dev/commits?author=bachitterch"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Bachitterch
              ...
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    ...
                    JA King{" "}
                    <a
                      href="https://github.com/qwertyroop/DDOX-dev/commit/3139ab20246105d87453b58334beaaa845c8e833"
                      target="_blank"
                      rel="noreferrer"
                    >
              ...
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    ...
                    <a
                      href="https://github.com/qwertyroop/DDOX-dev/commit/c89cd064571ec10f3e2dcf3455f6599c60c4f8f8"
                      target="_blank"
                      rel="noreferrer"
                    >
                      for the pull request and contribution
            ...
            <div className="w-full md:w-3/4 flex flex-col py-0 md:py-6 transition-all duration-150 ease-in-out">
              <ul className="gap-y-4 flex flex-col mb-0">
                <li className="flex flex-col items-start gap-y-1">
                  ...
                  <p className="text-sm mb-0">
                    Modal added to show users how to use DDOX after
